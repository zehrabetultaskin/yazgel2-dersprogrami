...
namespace Ders_Programı_Planlayıcı
{
    public partial class frmYeniDBSunucuGirisi : Form
    {
        ...
        private void btnBaglan_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO parametreler VALUES("+ frmAna.dayNumber+","+ frmAna.dailyNumberOfLessons + ")";
            cmd.ExecuteNonQuery();
            ...
            cmd.CommandText = "CREATE TABLE lessons (ders_kodu nvarchar(10) NOT NULL, name nvarchar(50) NOT NULL," +
                "dagilim_sekli nvarchar(50) NULL,zaman nvarchar("+ hds + ") NULL,CONSTRAINT[PK_dersler] PRIMARY KEY CLUSTERED(ders_kodu ASC))";
            cmd.ExecuteNonQuery();

            cmd.CommandText = "CREATE TABLE lectureHalls(derslik_kodu nvarchar(10) NOT NULL,name nvarchar(50) NOT NULL," +
                "zaman nvarchar(" + hds + ") NULL,CONSTRAINT[PK_derslikler] PRIMARY KEY CLUSTERED(derslik_kodu ASC))";
            cmd.ExecuteNonQuery();

            cmd.CommandText = "CREATE TABLE teachers(ogretmen_kodu nvarchar(10) NOT NULL,name nvarchar(50) NOT NULL," +
                "lastname nvarchar(50) NOT NULL,zaman nvarchar(" + hds + ") NULL,CONSTRAINT[PK_ogretmenler] PRIMARY KEY CLUSTERED(ogretmen_kodu ASC))";
            cmd.ExecuteNonQuery();

            cmd.CommandText = "CREATE TABLE classrooms(sinif_kodu nvarchar(10) NOT NULL,name nvarchar(50) NOT NULL,zaman nvarchar(" + hds + ") NULL," +
            ...
            cmd.CommandText = "ALTER TABLE [dbo].[ad_derslikler]  WITH CHECK ADD  CONSTRAINT [FK_ad_derslikler_atanan_dersler] FOREIGN KEY([ad_ID])REFERENCES[dbo].[atanan_dersler]([ad_ID]);" +
                ...
                "ALTER TABLE[dbo].[ad_derslikler]  WITH CHECK ADD CONSTRAINT[FK_ad_derslikler_derslikler] FOREIGN KEY([derslik_kodu])REFERENCES[dbo].[lectureHalls]([derslik_kodu]);" +
                ...
                "ALTER TABLE[dbo].[ad_ogretmenler]  WITH CHECK ADD CONSTRAINT[FK_ad_ogretmenler_ogretmenler] FOREIGN KEY([ogretmen_kodu])REFERENCES[dbo].[teachers]([ogretmen_kodu]);" +
                ...
                "ALTER TABLE[dbo].[ad_siniflar]  WITH CHECK ADD CONSTRAINT[FK_ad_siniflar_siniflar] FOREIGN KEY([sinif_kodu])REFERENCES[dbo].[classrooms]([sinif_kodu]);" +
                "ALTER TABLE[dbo].[ad_siniflar] CHECK CONSTRAINT[FK_ad_siniflar_siniflar];" +
                "ALTER TABLE[dbo].[atanan_dersler]  WITH CHECK ADD CONSTRAINT[FK_atanan_dersler_dersler] FOREIGN KEY([ders_kodu])REFERENCES[dbo].[lessons]([ders_kodu]);" +
